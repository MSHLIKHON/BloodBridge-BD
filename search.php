...
<section class="search-panel">
    <form method="get" class="search-form">
        ...
        <label><span>Location</span><input type="text" name="location" list="search-locations" value="<?= e($location) ?>" placeholder="Start typing a location" autocomplete="off" required><?php render_location_datalist('search-locations'); ?></label>
...
<div class="result-grid">
    ...
    <section class="content-card">
        ...
        <?php if (!$stocks): ?><div class="empty-state">No hospital stock found in this location.</div><?php else: ?><div class="result-list"><?php foreach ($stocks as $stock): ?><article class="result-item"><span class="blood-icon bank"><?= e($stock['blood_group']) ?></span><div><strong><?= e($stock['name']) ?></strong><span><?= e($stock['location']) ?></span><small><?= (int) $stock['units'] ?> unit(s) • <?= e($stock['phone']) ?></small></div></article><?php endforeach; ?></div><?php endif; ?>
