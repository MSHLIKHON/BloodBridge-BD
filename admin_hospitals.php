<?php
/** File purpose: Admin Hospitals handles the corresponding BloodBridge BD web workflow. */
    ...
    if (in_array($action, ['approve', 'reject'], true)) {
        ...
        if (!$errors) {
            ...
            try {
                ...
                if($action==='approve') require_verified_hospital($pdo,(int)$application['hospital_id']);
        ...
        if (!$errors) {
            try {
                ...
                foreach(valid_blood_groups() as $group) bb_exec($pdo,'INSERT INTO blood_inventory (hospital_id,blood_group,units,reserved_units) VALUES (?,?,0,0)',[$hospitalId,$group]);
...
?>
<section class="page-heading"><div><span class="eyebrow">Administrator control</span><h1>Hospitals &amp; staff verification</h1><p>Approve staff only after checking their hospital and employee information. <a href="hospital_verification.php">Verification references &amp; hospital status</a></p></div></section>
